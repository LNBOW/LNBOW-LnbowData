...
<div class="validateLogin" id="app">
        ...
        <!-- 尾部 -->
        <footer>
            <p class="psw"><router-link to='passwordlogin'>使用密码登录</router-link></p>
            <p class="register"><router-link to='register'>注册</router-link></p>
        </footer>
    </div>
</template>
...
.validateLogin main .code{position: relative;}
