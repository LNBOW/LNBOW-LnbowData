...
const loog = require('./images/icon.png');
const numbericFormat = require('./utils/numbericFormat');
const dateFormatter = require('./utils/formatDate');
const simpleTempalte = require('./utils/simpleTemplate');
const tips = require('./ktips.vue');
const supportsTouch = 'ontouchstart' in window || navigator.msMaxTouchPoints;

module.exports = candlestickLoader;
