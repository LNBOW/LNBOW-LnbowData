...
<div class="login" id="app">
        ...
        <main class="margin">
            <div>
                ...
                <!-- 中英文下拉框 -->
                  <ul id="ul" v-show="flag" @change="selectData"  :style = display>
                    <li :style="position" v-for="item in Countrys" v-bind:key="item.id" v-on:click="none(item.id)" >
                      <i>{{item.name}}</i>
                      <i>{{item.Acode}}</i>
                    </li>
                  </ul>
                <div class="code">
                    ...
                    <div class="jt" @click="selet">
                      ...
                      <img class="jts" v-show="a" src="../assets/img/jt.png">
                      <img class="jta" v-show="!a" src="../assets/img/jt1.png">
                    </div>
                </div>
            </div>
            <div>
        ...
        <footer class="margin">
            ...
            <div class="language">
              <!-- Language： -->
              <a href="javascript:;" :class="active" v-on:click="setLgC">简体</a> /
              <a href="javascript:;" :class="activenone" v-on:click="setLgEN">EN</a>
            </div>
        </footer>
    </div>
</template>
...
export default {
  ...
  data () {
    return {
      ...
      position:'background-position:3px 12px'
    }
  },
  computed:{
  ...
  methods:{
    ...
    setLgEN:function(b){
        ...
        this.flag = true
        this.flags = false
        this.activenone = 'active',
        this.active =''
        this.Countrys = this.ECountrys
        this.flag = false
      },
    //验证码中英文切换
